...
group --name=sgx --gid=1000
group --name=sev --gid=1001
...
user --name=npmccallum --groups=wheel,sev,sgx --lock --uid=1000 --gid=1002
...
user --name=haraldh --groups=wheel,sev,sgx --lock --uid=1001 --gid=1003
...
user --name=mbestavros --groups=sev,sgx --lock --uid=1002 --gid=1004
...
user --name=lkatalin --groups=sev,sgx --lock --uid=1003 --gid=1005
...
user --name=connorkuehl --groups=sev,sgx --lock --uid=1004 --gid=1006
...
user --name=whitebrandy --groups=sev,sgx --lock --uid=1005 --gid=1007
...
user --name=ueno --groups=sev,sgx --lock --uid=1006 --gid=1008
...
user --name=ziyi-yan --groups=sev,sgx --lock --uid=1007 --gid=1009
...
user --name=kubkon --groups=sev,sgx --lock --uid=1008 --gid=1010
